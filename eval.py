...
def evaluate(beam_size):
    ...
    weights = (1.0 / 1.0,)
    BLEU_1 = corpus_bleu(references, hypotheses, weights)

    weights = (1.0 / 2.0, 1.0 / 2.0,)
    BLEU_2 = corpus_bleu(references, hypotheses, weights)

    weights = (1.0 / 3.0, 1.0 / 3.0, 1.0 / 3.0,)
    BLEU_3 = corpus_bleu(references, hypotheses, weights)

    weights = (1.0 / 4.0, 1.0 / 4.0, 1.0 / 4.0, 1.0 / 4.0)
    BLEU_4 = corpus_bleu(references, hypotheses, weights)
...
if __name__ == '__main__':
    ...
    print("\nBLEU-1 score @ beam size of %d is %.4f." % (beam_size, scores[0] ))
    print("\nBLEU-2 score @ beam size of %d is %.4f." % (beam_size, scores[1] ))
    print("\nBLEU-3 score @ beam size of %d is %.4f." % (beam_size, scores[2] ))
    print("\nBLEU-4 score @ beam size of %d is %.4f." % (beam_size, scores[3] ))
